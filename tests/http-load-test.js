...
const rampUpDuration = parseInt(__ENV.K6_HTTP_RAMP_UP_DURATION_SECONDS || 30, 10);
const httpRampDownDurationSeconds = parseInt(__ENV.K6_HTTP_RAMP_DOWN_DURATION_SECONDS || 30, 10);
const enableLogs = __ENV.K6_ENABLE_LOGS === 'true';

export let options = {
    executor: 'ramping-vus',
    stages: [
        { duration: `${rampUpDuration}s`, target: httpRampUpVirtualUsers },
