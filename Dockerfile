...
RUN curl -L https://github.com/grafana/k6/releases/download/v0.57.0/k6-v0.57.0-linux-${TARGETARCH}.tar.gz -o /tmp/k6.tar.gz

RUN tar -xzf /tmp/k6.tar.gz -C /tmp
RUN mv /tmp/k6-v0.57.0-linux-${TARGETARCH}/k6 /usr/local/bin/
